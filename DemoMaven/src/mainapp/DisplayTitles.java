...
public class DisplayTitles extends JFrame {
	...
	public static void main() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DisplayTitles frame = new DisplayTitles();
	...
	public DisplayTitles() {
		...
		String fileName=properties.getProperty("titleOutput");
		...
		JLabel lblPreprocessedData = new JLabel("Preprocessed Title");
